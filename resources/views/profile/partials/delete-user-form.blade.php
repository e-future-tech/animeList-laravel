<div class="card shadow overflow-hidden rounded-5">
    <div class="card-header bg-danger text-white text-center">{{ __('Delete Account') }}</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-danger rouned-5" form="deleteAccountForm">
                    {{ __('Delete Account') }}
                </button>
            </div>
        </div>
